...
export const reducer = handleActions<IHumanState, IActionMeta>(
  {
    ...
    [types.REQUEST_PUT_ALL]: (state, action) => ({
      ...state,
      isWearingHat: true,
      isWearingGlasses: true,
      isWearingUpperClothes: true,
    ...
    [types.RECIEVE_PUT_ALL]: (state, action: ActionMeta<IActionHat & IActionGlasses & IActionUpperClothes & IActionLowerClothes & IActionShoes, IActionMeta>) => ({
      ...state,
      isWearingHat: false,
      isWearingGlasses: false,
      isWearingUpperClothes: false,
